...
function getData() {
    $.ajax({
        ...
        success: function (getData) {
            ...
            <div class="bar bar-2 stat-3" style="height: '+Math.min(buy/50000*100,100)+'%;"></div>\
            </div>';
            $area.append(str);
            str = '<div class="bar-group">\
            <div class="bar bar-2 stat-1" style="height: '+Math.min(sale/50000*100,100)+'%;"></div>\
            </div>';
            $area.append(str);
            str = '<div class="bar-group">\
            <div class="bar bar-2 stat-2" style="height: '+Math.min(repair/50000*100,100)+'%;"></div>\
            </div>';
            $area.append(str);
            str = '<div class="bar-group">\
            <div class="bar bar-2 stat-3" style="height: '+Math.min(license/50000*100,100)+'%;"></div>\
            </div>';
            $area.append(str);
